...
import {Attendee, DateTime, Location, RecurrencePattern, RecurrenceWeekly, RecurrenceWeeklyPattern, Schedule, Status, Transparency, Visibility} from "../../../app/js/main/schedule";
...
test("schedule store can store and load schedules", async t => {
    ...
    let schedule: Schedule = {
		...
		attendees: [
			new Attendee("10", "田中 太郎"),
			new Attendee("3", "山田 二郎")
		],
